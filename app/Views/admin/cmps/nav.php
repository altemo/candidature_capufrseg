<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="/galerie" class="nav-link <?= $request->uri->getSegment(1) == 'galerie' ? 'active' : null; ?>">
                <i class="nav-icon fas fa-users"></i>
                <p>Gal&eacuterie</p>
            </a>
        </li>
        <li class="nav-item">
            <a href="/dashevent" class="nav-link <?= $request->uri->getSegment(1) == 'dashevent' ? 'active' : null; ?>">
                <i class="nav-icon fas fa-users"></i>
                <p>&Eacute;v&egrave;nements</p>
            </a>
        </li>
        <li class="nav-item">
