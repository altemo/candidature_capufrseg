...
<html lang="en">
  <head>
	...
	Favicons
	=============================================== -->
	<link rel="shortcut icon" href="<?= base_url() ?>/oirp/assets/img/favicon.ico">
	<link rel="apple-touch-icon" href="<?= base_url() ?>/oirp/assets/img/apple-touch-icon.png">
	<link rel="apple-touch-icon" sizes="72x72" href="<?= base_url() ?>/oirp/assets/img/apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="114x114" href="<?= base_url() ?>/oirp/assets/img/apple-touch-icon-114x114.png">
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url() ?>/oirp/assets/css/bootstrap-dropdownhover.min.css">
	
	<!-- ==============================================
	Custom Stylesheet
	=============================================== -->
	<link rel="stylesheet" type="text/css" href="<?= base_url() ?>/oirp/assets/css/style.css" />
	<!--
...
<body>
                    ...
                    <div class="box-icon-1" style="margin-top: 10px;">
						<div class="body-content">
                            <a class="navbar-brand-" href="/">
                                <img src="http://oirp.test:8080/oirp/assets/img/logo_unicef.jpeg" alt="" class="pt-0" width="120">
                            </a>
						</div>
					</div>
		...
		<div class="navbar-main">
			<div class="container">
			    <nav class="navbar navbar-expand-lg">
			        <a class="navbar-brand" href="/">
						<img src="<?= base_url() ?>/oirp/assets/img/logo_oirp.png" alt="" width="120" class="pt-0"/>
					</a>
					...
					<div class="col-sm-12 col-md-12">
						<div class="cta-1">
                            ...
                            <div class="body-action">
                                <a href="#" class="btn btn-danger">Faire un Don aujourd'hui</a>
                            </div>
			            </div>
					</div>
				</div>
	...
	<!-- FOOTER SECTION -->
	<div class="footer" data-background="<?= base_url() ?>/oirp/assets/img/bg-map-dot.jpg">
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-md-3">
                            <div class="footer-item">
                                <img src="<?= base_url() ?>/oirp/assets/img/logo_oirp.png" alt="logo bottom" width="120" class="logo-bottom">
                            ...
                            <div class="footer-item">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-6">
                                        <ul class="list">
                                            <li><a href="about.html" title="About us">
                                                <i class="fa fa-angle-right"></i> A propos</a></li>
                                            <li><a href="couses.html" title="Couses">
                                                <i class="fa fa-angle-right"></i> Causes</a></li>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <ul class="list">
                                            <li><a href="our-team.html" title="Our Team">
	...
	<!-- JS VENDOR -->
	<script src="<?= base_url() ?>/oirp/assets/js/jquery.min.js"></script>
	<script src="<?= base_url() ?>/oirp/assets/js/bootstrap.min.js"></script>
	<script src="<?= base_url() ?>/oirp/assets/js/owl.carousel.js"></script>
	<script src="<?= base_url() ?>/oirp/assets/js/jquery.magnific-popup.min.js"></script>

	<!-- SENDMAIL -->
	<script src="<?= base_url() ?>/oirp/assets/js/validator.min.js"></script>
	<script src="<?= base_url() ?>/oirp/assets/js/form-scripts.js"></script>

	<script src="<?= base_url() ?>/oirp/assets/js/script.js"></script>
