...
class Crud_core
{
    ...
    function __construct($params, RequestInterface $request)
    {
        ...
        $this->action = (isset($params['form_action']) ? $params['form_action'] : 'add');
        //Field options
    ...
    function parent_form()
    {
        ...
        $form .= '<div class="card card-primary">
            <div class="card-header">
              ...
              if($this->multipart){
                $form .= form_open_multipart('/' . $this->base . '/' . $this->table . '/' . ($this->action == 'add' ? 'add' : ($this->action == 'edit'?'edit/' . $this->id:$this->action ) )) . '<div class="card-body">';
              }else{
                $form .= form_open('/' . $this->base . '/' . $this->table . '/' . ($this->action == 'add' ? 'add' : ($this->action == 'edit'?'edit/' . $this->id:$this->action ) )) . '<div class="card-body">';
              }
